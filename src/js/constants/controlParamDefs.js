const CONTROL_PARAM_DEFS = [
  ...
  { key: 'enableMobilePoemScale', type: 'bool' },
  { key: 'mobilePoemScaleMaxWidthPx', type: 'number', digits: 0 },
  { key: 'mobilePoemScale', type: 'number', digits: 2 },
  { key: 'enablePinchZoom', type: 'bool' },
  { key: 'pinchZoomMin', type: 'number', digits: 2 },
  { key: 'pinchZoomMax', type: 'number', digits: 2 },
  { key: 'enablePinchZoomScrollComp', type: 'bool' },
  ...
  { key: 'enableBackgroundTone', type: 'bool' },
  { key: 'backgroundToneBlackPoint', type: 'number', digits: 3 },
  { key: 'backgroundToneGamma', type: 'number', digits: 2 },
  { key: 'backgroundToneGain', type: 'number', digits: 2 },
  { key: 'backgroundToneAlphaBlackPoint', type: 'number', digits: 3 },
  { key: 'backgroundToneAlphaGamma', type: 'number', digits: 2 },
  { key: 'backgroundFilterOnWrapper', type: 'bool' },
  ...
  { key: 'particleSimFraction', type: 'number', digits: 2 },
  { key: 'enableAdaptiveQuality', type: 'bool' },
  { key: 'lockQualityLevel', type: 'bool' },
  { key: 'qualityTargetFps', type: 'number', digits: 0 },
  { key: 'qualityDegradeRate', type: 'number', digits: 2 },
  { key: 'qualityRecoverRate', type: 'number', digits: 2 },
  { key: 'qualityDeadband', type: 'number', digits: 3 },
  ...
  { key: 'autoScrollDeltaCapMultiple', type: 'number', digits: 1 },
  ...
  { key: 'enableGlowFlicker', type: 'bool' },
  { key: 'glowFlickerDepth', type: 'number', digits: 2 },
  { key: 'glowFlickerSpeed', type: 'number', digits: 2 },
  ...
  { key: 'scrollBufferViewports', type: 'number', digits: 1 },
  { key: 'enableTouchScroll', type: 'bool' },
  { key: 'touchScrollGain', type: 'number', digits: 2 },
  { key: 'touchVerticalWeight', type: 'number', digits: 2 },
  { key: 'enableTouchInertia', type: 'bool' },
  { key: 'touchInertiaDecay', type: 'number', digits: 3 },
  { key: 'touchInertiaMinSpeed', type: 'number', digits: 3 },
  { key: 'touchInertiaMaxSpeed', type: 'number', digits: 1 },
  { key: 'touchEdgeGuardPx', type: 'number', digits: 0 },
