const CONTROL_TOOLTIPS = {
  ...
  curlAngleRangeDeg: 'Maximum deflection of the curl field to either side of the wind direction, in degrees. 90 keeps all flow broadly downwind; 180 allows any direction.',
